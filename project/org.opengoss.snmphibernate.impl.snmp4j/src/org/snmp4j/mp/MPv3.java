...
*/
  ...
  public int prepareResponseMessage(int messageProcessingModel,
                                    ...
                                    BEROutputStream outgoingMessage) throws
      IOException {
    /**@todo Leave entry in cache or remove it? RFC3414 §3.1.a.1 says discard it*/
...
//      long startPos = wholeMsg.getReadCount();
      wholeMsg.mark(16);
          ...
          if (scopedPdu.getType() == PDU.REPORT) {
            ...
            if (((cacheEntry.getSecurityEngineID().length != 0) &&
                ...
                ((!securityName.equals(cacheEntry.getSecurityName()) &&
                   (!securityName.equals("initial".getBytes())) &&
