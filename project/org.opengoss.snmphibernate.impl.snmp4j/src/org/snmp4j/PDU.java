...
public class PDU implements BERSerializable {
  ...
  public void trim() {
    if (variableBindings.size() > 0) {
      variableBindings.removeElementAt(variableBindings.size() - 1);
    }
  }
  ...
  /**
   * Removes all variable bindings from the PDU. This can be used to reuse
   * a PDU for another request.
   */
  public void clear() {
