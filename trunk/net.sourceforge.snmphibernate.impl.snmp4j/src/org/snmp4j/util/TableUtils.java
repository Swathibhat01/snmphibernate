...
public class TableUtils {
  ...
  public static int ROWSTATUS_ACTIVE = 1;
  public static int ROWSTATUS_NOTINSERVICE = 2;
  public static int ROWSTATUS_NOTREADY = 3;
  public static int ROWSTATUS_CREATEANDGO = 4;
  public static int ROWSTATUS_CREATEANDWAIT = 5;
  public static int ROWSTATUS_DESTROY = 6;
