...
public class MessageDispatcherImpl implements MessageDispatcher {
      ...
      throws MessageException
  {
    try {
      MessageProcessingModel mp =
          (MessageProcessingModel)mpm.get(messageProcessingModel);
      if (mp == null) {
      ...
      if (!mp.isProtocolVersionSupported(messageProcessingModel)) {
        throw new MessageException("SNMP version "+messageProcessingModel+" is not supported "+
                                   "by message processing model "+messageProcessingModel);
      }
      if (transport == null) {
