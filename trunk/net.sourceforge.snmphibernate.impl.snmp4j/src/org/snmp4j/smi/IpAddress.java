...
public class IpAddress extends SMIAddress {
	...
	static final long serialVersionUID = -146846354059565449L;
	 ...
	 * 
	 * @param address
	 *            an <code>InetAddress</code> instance (must not necessarily
	 *            be a IPv4 address).
	 */
	 ...
	 * 
	 * @param address
	 *            an IP address string which may be a host name or a numerical
	 *            IP address.
	...
	public int compareTo(Object o) {
		...
		return a.compareTo(new OctetString(((IpAddress) o).getInetAddress()
				.getAddress()));
	}
