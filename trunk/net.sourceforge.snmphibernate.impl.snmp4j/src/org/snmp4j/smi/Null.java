...
/**
 * The <code>Null</code> class represents SMI Null and the derived SMIv2
 * exception syntaxes.
 * 
 * @author Frank Fock
 * @version 1.7
...
public class Null extends Variable {
	...
	public static final Null noSuchObject = new Null(
			SMIConstants.EXCEPTION_NO_SUCH_OBJECT);

	public static final Null noSuchInstance = new Null(
			SMIConstants.EXCEPTION_NO_SUCH_INSTANCE);

	public static final Null endOfMibView = new Null(
			SMIConstants.EXCEPTION_END_OF_MIB_VIEW);

	public static final Null instance = new Null(SMIConstants.SYNTAX_NULL);
	...
	public void setSyntax(int syntax) {
		if ((syntax != SMIConstants.SYNTAX_NULL)
				&& (!isExceptionSyntax(syntax))) {
