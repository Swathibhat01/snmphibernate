 ...
 * @since 1.0
 */
public class OctetString extends Variable implements AssignableFromByteArray,
  ...
  public void decodeBER(BERInputStream inputStream) throws java.io.IOException {
    ...
    if (type.getValue() != (BER.ASN_UNIVERSAL | 0x04)) {
  ...
  public OctetString substring(int beginIndex, int endIndex) {
    if ((beginIndex < 0) || (endIndex > length())) {
      /**@todo Implement better exception message */
