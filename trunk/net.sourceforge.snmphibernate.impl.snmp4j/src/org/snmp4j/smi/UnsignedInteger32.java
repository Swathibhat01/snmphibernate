 ...
 * @version 1.7
 */
public class UnsignedInteger32 extends Variable implements AssignableFromLong,
	...
	/**
	 * Creates an <code>UnsignedInteger32</code> from a <code>long</code>
	 * value.
	 * 
	 * @param value
	 *            a <code>long</code> value which must not be greater 2^32-1
	 *            and not less zero.
	...
	public void decodeBER(BERInputStream inputStream)
		...
		if (type.getValue() != BER.GAUGE) {
			throw new IOException(
					"Wrong type encountered when decoding Gauge: "
							+ type.getValue());
		}
		setValue(newValue);
	}
